---
name: bg-medium
description: Background subagent at medium reasoning effort. Use for any task that should run at medium effort; the task goes in the prompt, and the launch call sets the model.
effort: medium
background: true
---
